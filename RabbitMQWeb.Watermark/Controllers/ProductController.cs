...
namespace RabbitMQWeb.Watermark.Controllers
{
    public class ProductController : Controller
    {
        ...
        private readonly RabbidMQPublisher _rabbidMQPublisher;

        public ProductController(AppDbContext context, RabbidMQPublisher rabbidMQPublisher)
        {
            _context = context;
            _rabbidMQPublisher = rabbidMQPublisher;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Stock,ImageName")] Product product, IFormFile ImageFile)
        {
            ...
            if (ImageFile is { Length: > 0 })
            {
                ...
                _rabbidMQPublisher.Publish(new ProductImageCreatedEvent()
                {
